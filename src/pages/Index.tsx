...
const Index = () => {
  return (
    <>
      <Helmet>
        <title>Peak Focus Improved: Focus & Reading Tools</title>
        <meta name="description" content="ADHD-friendly focus timer and reading tools with a calm indigo UI. Start focusing with Peak Focus Improved." />
