...
import { Timer, Mountain, Camera, BarChart2, Settings as Cog } from "lucide-react";

function NavIconLink({ to, label, children }: { to: string; label: string; children: React.ReactNode }) {
  return (
    <NavLink
      to={to}
      aria-label={label}
